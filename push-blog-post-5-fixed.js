...
import blogPost from './blog-content/uk-small-business-startup-trends-2025.js';
...
async function insertBlogPost() {
  ...
  try {
    ...
    const result = await client.query(insertQuery, [
      ...
      'Market Trends', // content_category
      1, // Default author_id
      'published', // status
      false, // is_featured
      true, // is_pillar
      blogPost.primaryKeywords?.[0] || 'UK small business startup trends 2025', // target_keyword
    ...
    console.log(`Category: Market Trends`);
