-- =============================================================================
-- COMPLETE SIDEBAR CONVERSATIONS DATABASE FIX
-- Import this file into pgAdmin to fix all conversation sidebar issues
-- =============================================================================
...
-- Create function to update conversation when messages are added
...
-- Create a view for easy sidebar data access
...
DECLARE
    ...
    conversations_with_titles INTEGER;
    conversations_with_participants INTEGER;
    ai_conversations INTEGER;
BEGIN
    SELECT COUNT(*) INTO total_conversations FROM conversations;
    SELECT COUNT(*) INTO conversations_with_titles FROM conversations WHERE title IS NOT NULL AND title != '';
    ...
    RAISE NOTICE '=== SIDEBAR CONVERSATIONS FIX COMPLETED ===';
    RAISE NOTICE 'Total conversations: %', total_conversations;
    RAISE NOTICE 'Conversations with titles: %', conversations_with_titles;
    ...
    RAISE NOTICE 'Database is ready for sidebar functionality!';
END $$;
