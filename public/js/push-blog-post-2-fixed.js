...
import blogPost from '../../blog-content/ai-business-valuation-revolution-uk-2025.js';
...
async function insertBlogPost() {
  ...
  try {
    ...
    const result = await client.query(insertQuery, [
      ...
      'Business Valuation', // content_category
      1, // Default author_id
      'published', // status
      false, // is_featured
      true, // is_pillar
      blogPost.primaryKeywords?.[0] || 'AI business valuation', // target_keyword
    ...
    console.log(`Category: Business Valuation`);
