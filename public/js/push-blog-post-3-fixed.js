...
import blogPost from '../../blog-content/uk-online-business-marketplace-guide-2025.js';
...
async function insertBlogPost() {
  ...
  try {
    ...
    const result = await client.query(insertQuery, [
      ...
      'Business Marketplace', // category
      'Business Marketplace', // content_category
      1, // Default author_id
      'published', // status
      false, // is_featured
      true, // is_pillar
      blogPost.primaryKeywords?.[0] || 'UK business marketplace', // target_keyword
    ...
    console.log(`Category: Business Marketplace`);
