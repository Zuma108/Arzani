...
async function insertBlogPost() {
  ...
  try {
    ...
    const result = await client.query(insertQuery, [
      ...
      'Business Acquisition', // content_category
      1, // Default author_id
      'published', // status
      false, // is_featured
      true, // is_pillar
      blogPost.primaryKeywords?.[0] || 'UK business acquisition trends 2025', // target_keyword
    ...
    console.log(`Category: Business Acquisition`);
